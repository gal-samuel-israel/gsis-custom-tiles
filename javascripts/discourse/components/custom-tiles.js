...
export default Component.extend({
  ...
  didInsertElement() {      
    ...
    jQuery('#tile-img-1 > img:first-child').attr('src',img1);
    jQuery('#tile-img-2 > img:first-child').attr('src',img2);
    jQuery('#tile-img-3 > img:first-child').attr('src',img3);
    jQuery('#tile-img-4 > img:first-child').attr('src',img4);
