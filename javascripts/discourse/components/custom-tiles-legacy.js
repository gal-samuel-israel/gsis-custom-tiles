...
export default Component.extend({
  ...
  didInsertElement() {
    ...
    if (settings.enable_tile_images) {
      const img1 =
        settings.tile_1_image !== "" && settings.tile_1_image !== null
          ? settings.tile_1_image
          : assets.img_get_started;
      const img2 =
        settings.tile_2_image !== "" && settings.tile_2_image !== null
          ? settings.tile_2_image
          : assets.img_ask_the_community;
      const img3 =
        settings.tile_3_image !== "" && settings.tile_3_image !== null
          ? settings.tile_3_image
          : assets.img_announcements;
      const img4 =
        settings.tile_4_image !== "" && settings.tile_4_image !== null
          ? settings.tile_4_image
          : assets.img_show_and_tell;
      const img5 =
        settings.tile_5_image !== "" && settings.tile_5_image !== null
          ? settings.tile_5_image
          : assets.img_product_road_map;
    ...
    if (settings.enable_banner_above_tiles) {
      const imgBanner =
        settings.banner_image !== "" && settings.banner_image !== null
